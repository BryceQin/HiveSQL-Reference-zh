...
- [2. 内建函数(Built-in Functions)](#2-内建函数built-in-functions)
    ...
    - [2.6 字符串函数(String Functions)](#26-字符串函数string-functions)
        ...
        - [2.6.3 字符串计算](#263-字符串计算)
            ...
            - [2.6.3.4 `levenshtein`](#2634-levenshtein)
        - [2.6.4 字符串查找、替换](#264-字符串查找替换)
            - [2.6.4.1 `locate`](#2641-locate)
            - [2.6.4.2 `instr`](#2642-instr)
            - [2.6.4.3 `field`](#2643-field)
            - [2.6.4.4 `elt`](#2644-elt)
            - [2.6.4.5 `like`](#2645-like)
            - [2.6.4.6 `replace`](#2646-replace)
            - [2.6.4.7 `translate`](#2647-translate)
            - [2.6.4.8 `mask`](#2648-mask)
            - [2.6.4.9 `mask_first_n`](#2649-mask_first_n)
            - [2.6.4.10 `mask_last_n`](#26410-mask_last_n)
            - [2.6.4.11 `mask_show_first_n`](#26411-mask_show_first_n)
            - [2.6.4.12 `mask_show_last_n`](#26412-mask_show_last_n)
            - [2.6.4.13 `rlike、regexp`](#26413-rlikeregexp)
            - [2.6.4.14 `regexp_replace`](#26414-regexp_replace)
        - [2.6.5 字符串截取、分割、拼接](#265-字符串截取分割拼接)
            ...
            - [2.6.5.3 `split`](#2653-split)
            - [2.6.5.4 `concat`](#2654-concat)
            - [2.6.5.5 `concat_ws`](#2655-concat_ws)
            - [2.6.5.6 `regexp_extract`](#2656-regexp_extract)
            - [2.6.5.7 `sentences`](#2657-sentences)
...
举例：
    ...
    -- 结果：'1b3'
```
#### 2.6.4.8 [`mask`](#271-mask)
#### 2.6.4.9 [`mask_first_n`](#272-mask_first_n)
#### 2.6.4.10 [`mask_last_n`](#273-mask_last_n)
#### 2.6.4.11 [`mask_show_first_n`](#274-mask_show_first_n)
#### 2.6.4.12 [`mask_show_last_n`](#275-mask_show_last_n)
#### 2.6.4.13 `rlike、regexp`
```sql
描述：
    检查字符串是否符合某种正则表达式
语法：
