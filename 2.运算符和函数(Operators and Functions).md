...
- [2. 内建函数(Built-in Functions)](#2-内建函数built-in-functions)
    ...
    - [2.6 字符串函数(String Functions)](#26-字符串函数string-functions)
        ...
        - [2.6.2 字符串转化](#262-字符串转化)
            ...
            - [2.6.2.6 `lower`](#2626-lower)
            - [2.6.2.7 `upper`](#2627-upper)
            - [2.6.2.8 `initcap`](#2628-initcap)
            - [2.6.2.9 `reverse`](#2629-reverse)
        ...
        - [2.6.4 字符串补齐、替换前后空格](#264-字符串补齐替换前后空格)
            - [2.6.4.1 `lpad`](#2641-lpad)
            - [2.6.4.2 `rpad`](#2642-rpad)
            - [2.6.4.3 `trim`](#2643-trim)
            - [2.6.4.3 `ltrim`](#2643-ltrim)
            - [2.6.4.4 `rtrim`](#2644-rtrim)
        - [2.6.5 字符串替换](#265-字符串替换)
            - [2.6.5.1 `replace`](#2651-replace)
            - [2.6.5.2 `translate`](#2652-translate)
            - [2.6.5.3 `mask`](#2653-mask)
            - [2.6.5.4 `mask_first_n`](#2654-mask_first_n)
            - [2.6.5.5 `mask_last_n`](#2655-mask_last_n)
            - [2.6.5.6 `mask_show_first_n`](#2656-mask_show_first_n)
            - [2.6.5.7 `mask_show_last_n`](#2657-mask_show_last_n)
        - [2.6.6 字符串截取](#266-字符串截取)
        - [2.6.7 字符串分割、拼接](#267-字符串分割拼接)
        - [2.6.8 字符串查找](#268-字符串查找)
        - [2.6.9 字符串相似性计算](#269-字符串相似性计算)
        - [2.6.10 正则表达式](#2610-正则表达式)
        - [2.6.11 分词与词频统计](#2611-分词与词频统计)
        - [2.6.12 特征值计算](#2612-特征值计算)
...
举例：
    ...
    结果：'1b3'
```
#### 2.6.5.3 [`mask`](#271-mask)
#### 2.6.5.4 [`mask_first_n`](#272-mask_first_n)
#### 2.6.5.5 [`mask_last_n`](#273-mask_last_n)
#### 2.6.5.6 [`mask_show_first_n`](#274-mask_show_first_n)
#### 2.6.5.7 [`mask_show_last_n`](#275-mask_show_last_n)
### 2.6.6 字符串截取
### 2.6.7 字符串分割、拼接
### 2.6.8 字符串查找
### 2.6.9 字符串相似性计算
