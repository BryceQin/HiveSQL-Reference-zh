...
- [1. 内建运算符(Built-in Operators)](#1-内建运算符built-in-operators)
    ...
    - [1.2 Relational Operators(关系运算符)](#12-relational-operators关系运算符)
        ...
        - [1.2.3 小于比较 `<`](#123-小于比较-)
        - [1.2.4 小于等于比较 `<=`](#124-小于等于比较-)
        - [1.2.5 大于比较 `>`](#125-大于比较-)
        - [1.2.6 大于等于比较 `>=`](#126-大于等于比较-)
        - [1.2.7 区间比较 `BETWEEN...AND`](#127-区间比较-betweenand)
        - [1.2.8 空值判断 `IS NULL`](#128-空值判断-is-null)
        - [1.2.9 非空判断 `IS NOT NULL`](#129-非空判断-is-not-null)
        - [1.2.10 是非判断 `IS [NOT] (TRUE|FALSE)`](#1210-是非判断-is-not-truefalse)
        - [1.2.11 字符比较 `[NOT] LIKE`](#1211-字符比较-not-like)
        - [1.2.12 字符正则比较 `[NOT] RLIKE|REGEXP`](#1212-字符正则比较-not-rlikeregexp)
...
```
### 1.2.12 字符正则比较 `[NOT] RLIKE|REGEXP`
```sql
语法：
