...
- [2. 内建函数(Built-in Functions)](#2-内建函数built-in-functions)
    ...
    - [2.6 字符串函数(String Functions)](#26-字符串函数string-functions)
        ...
        - [2.6.6 字符串查找](#266-字符串查找)
            - [2.6.6.1 `locate`](#2661-locate)
            - [2.6.6.2 `instr`](#2662-instr)
            - [2.6.6.3 `field`](#2663-field)
            - [2.6.6.4 `elt`](#2664-elt)
        - [2.6.7 字符串相似性计算](#267-字符串相似性计算)
            - [2.6.7.1 `like`](#2671-like)
            - [2.6.7.2 `levenshtein`](#2672-levenshtein)
